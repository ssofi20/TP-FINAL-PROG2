      ...
      : _turno(0, Fecha(0,0,0), Hora(0,0),1 )
        {
            ...
            _estado = true;
            /// Falta settear el turno
        }

        Estudio::Estudio(const char *IDEstudio, int dni, int estEstudio, const char *sala, Turnos turno, bool estado)
        {
        ...
        void Estudio::setTurno(Turnos turno)
        {
            _turno = turno;
        }
